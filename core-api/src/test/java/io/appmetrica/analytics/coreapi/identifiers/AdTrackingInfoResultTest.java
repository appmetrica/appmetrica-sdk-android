...
public class AdTrackingInfoResultTest extends CommonTest {
    ...
    public void testDefaultConstructor() throws Exception {
        ...
        ObjectPropertyAssertions<AdTrackingInfoResult> assertions = Assertions.INSTANCE.ObjectPropertyAssertions(adTrackingInfoResult);
    ...
    public void getProviderUnavailableResult() throws IllegalAccessException {
        ...
        Assertions.INSTANCE.ObjectPropertyAssertions(AdTrackingInfoResult.getProviderUnavailableResult(errorMessage))
