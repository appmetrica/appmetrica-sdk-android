...
public class MainReporter extends BaseReporter implements IMainReporter {
    ...
    public void setAdvIdentifiersTracking(boolean enabled, boolean force) {
        ...
        DebugLogger.INSTANCE.info(getTag(), "Set advIdentifiersTracking to %s, force = %s", enabled, force);
        mReporterEnvironment.getReporterConfiguration().setAdvIdentifiersTracking(enabled, force);
    }
