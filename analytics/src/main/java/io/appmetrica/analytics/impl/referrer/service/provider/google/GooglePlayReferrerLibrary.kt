            ...
            DebugLogger.info(
                ...
                "Google Play referrer library return referrer: " + referrer?.let {
                    buildString {
                        ...
                        append(", googlePlayInstantParam=")
                        append(it.googlePlayInstantParam)
                        append(", referrerClickTimestampServerSeconds=")
                        append(it.referrerClickTimestampServerSeconds)
                        append(", installBeginTimestampServerSeconds=")
                        append(it.installBeginTimestampServerSeconds)
                        append(", installVersion=")
                        append(it.installVersion)
                        append(")")
                    }
                }
            )
