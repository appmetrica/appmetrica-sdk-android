...
internal class PushCrashProcessorCreator : TechnicalCrashProcessorCreator {
    ...
    override fun createCrashProcessor(
        ...
        return ReporterBasedCrashProcessor(
            context,
            UnhandledSituationReporterProvider(reporterFactoryProvider, SdkData.SDK_API_KEY_PUSH_SDK),
            { exception -> SdkUtils.isExceptionFromPushSdk(exception) },
            null
        )
    }
}
