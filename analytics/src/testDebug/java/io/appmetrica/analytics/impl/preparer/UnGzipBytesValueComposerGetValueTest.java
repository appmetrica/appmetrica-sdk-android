...
public class UnGzipBytesValueComposerGetValueTest extends CommonTest {
    ...
    public UnGzipBytesValueComposerGetValueTest(byte[] input, byte[] expected) {
        this.input = input;
    ...
    public static Collection<Object[]> data() {
        ...
        byte[] medium = randomBytes(200 * 1024);
        byte[] large = randomBytes(1024 * 1024);
    ...
    private final UnGzipBytesValueComposer composer = new UnGzipBytesValueComposer();
