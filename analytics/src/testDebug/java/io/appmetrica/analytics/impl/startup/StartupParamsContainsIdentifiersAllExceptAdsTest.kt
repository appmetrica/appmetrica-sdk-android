...
internal class StartupParamsContainsIdentifiersAllExceptAdsTest(
    ...
    requestedIdentifiers = StartupParamsTestUtils.ALL_IDENTIFIERS_EXCEPT_ADV,
    clientClids = null,
    ...
    @Test
    fun `containsIdentifiers for ALL_IDENTIFIERS_EXCEPT_ADV`() {
        assertThat(startupParams.containsIdentifiers(requestedIdentifiers))
            .isEqualTo(expected.containsIdentifiers)
    }

    @Test
    fun `shouldSendStartup for ALL_IDENTIFIERS_EXCEPT_ADV`() {
