...
internal class StartupStateStorageTest : CommonTest() {
    ...
    private val hostUrlsFromLibraryAdapter = listOf("adapter url 1", "adapter url 2")
    ...
    fun readEmptyValue() {
        ...
        ObjectPropertyAssertions(startupState)
            ...
            .checkFieldIsNull("hostUrlsFromLibraryAdapter")
    ...
    fun saveEmptyValue() {
        ...
        assertions.checkFieldIsNull("hostUrlsFromLibraryAdapter")
    ...
    fun readFilledValue() {
        ...
        ObjectPropertyAssertions(startupStateStorage.read())
            ...
            .checkField("hostUrlsFromLibraryAdapter", hostUrlsFromLibraryAdapter)
