...
public class ReportPermissionHandlerTest extends CommonTest {
    ...
    public void testEmptyPermissionsSent() {
        ...
        verify(mEventSaver, times(1)).savePermissionsReport(any(CoreServiceEvent.class));
    ...
    public void testPermissionsAndBgRestrictionsNotUpdatedAndShouldForceSend() {
        ...
        verify(mEventSaver).savePermissionsReport(any(CoreServiceEvent.class));
    ...
    public void testPermissionsAndBgRestrictionsNotUpdatedAndShouldNotForceSend() {
        ...
        verify(mEventSaver, never()).savePermissionsReport(any(CoreServiceEvent.class));
        verify(mPermissionsStorage, never()).save(any(AppPermissionsState.class));
    }
    ...
    public void testBackgroundRestrictions() {
        ...
        mReportPermissionsHandler.process(new CoreServiceEvent());
        ArgumentCaptor<CoreServiceEvent> captor = ArgumentCaptor.forClass(CoreServiceEvent.class);
