...
class UnhandledExceptionFactoryTest : CommonTest() {
    ...
    fun getUnhandledExceptionFromJavaFilled() {
        ...
        ObjectPropertyAssertions(result)
            ...
            .checkFieldComparingFieldByFieldRecursively("methodCallStacktrace", listOf(StackTraceItemInternal(element1), StackTraceItemInternal(element2)))
        ...
        ObjectPropertyAssertions(result)
            .checkFieldRecursively<ThrowableModel>("exception") {
                it
                    ...
                    .checkFieldComparingFieldByFieldRecursively("stacktrace", listOf(StackTraceItemInternal(element1), StackTraceItemInternal(element2)))
