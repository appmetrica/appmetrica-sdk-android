...
public class InternalEventsToProtoMappingTest extends CommonTest {
    ...
    public static Collection<Object[]> data() {
        Collection<Object[]> data = Arrays.asList(new Object[][]{
                ...
                {InternalEvents.EVENT_TYPE_PREV_SESSION_CRASHPAD_CRASH_PROTOBUF, EventProto.ReportMessage.Session.Event.EVENT_PROTOBUF_CRASH},
                {InternalEvents.EVENT_TYPE_CURRENT_SESSION_CRASHPAD_CRASH_PROTOBUF, EventProto.ReportMessage.Session.Event.EVENT_PROTOBUF_CRASH},
