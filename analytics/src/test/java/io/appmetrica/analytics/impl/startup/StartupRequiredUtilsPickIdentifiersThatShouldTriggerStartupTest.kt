...
class StartupRequiredUtilsPickIdentifiersThatShouldTriggerStartupTest(
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> = listOf(
            ...
            arrayOf(listOf(Constants.StartupParamsCallbackKeys.UUID), listOf(
                Constants.StartupParamsCallbackKeys.UUID
            )),
            arrayOf(listOf(Constants.StartupParamsCallbackKeys.DEVICE_ID), listOf(
                Constants.StartupParamsCallbackKeys.DEVICE_ID
            )),
            arrayOf(listOf(Constants.StartupParamsCallbackKeys.DEVICE_ID_HASH), listOf(
                Constants.StartupParamsCallbackKeys.DEVICE_ID_HASH
            )),
            arrayOf(listOf(Constants.StartupParamsCallbackKeys.GET_AD_URL), listOf(
                Constants.StartupParamsCallbackKeys.GET_AD_URL
            )),
            // #5
            arrayOf(listOf(Constants.StartupParamsCallbackKeys.REPORT_AD_URL), listOf(
                Constants.StartupParamsCallbackKeys.REPORT_AD_URL
            )),
            arrayOf(listOf(Constants.StartupParamsCallbackKeys.CLIDS), listOf(
