...
public class ThrowableConverterTest extends CommonTest {
    ...
    public void toProto() throws IllegalAccessException {
        ...
        List<StackTraceItemInternal> mainStacktrace = Arrays.asList(mock(StackTraceItemInternal.class));
        ...
        List<StackTraceItemInternal> cause1Stacktrace = Arrays.asList(mock(StackTraceItemInternal.class));
        ...
        List<StackTraceItemInternal> cause2Stacktrace = Arrays.asList(mock(StackTraceItemInternal.class));
        ...
        List<StackTraceItemInternal> cause3Stacktrace = Arrays.asList(mock(StackTraceItemInternal.class));
        ...
        List<StackTraceItemInternal> suppressed1Stacktrace = Arrays.asList(mock(StackTraceItemInternal.class));
        ...
        List<StackTraceItemInternal> suppressed2Stacktrace = Arrays.asList(mock(StackTraceItemInternal.class));
        ...
        List<StackTraceItemInternal> suppressed3Stacktrace = Arrays.asList(mock(StackTraceItemInternal.class));
        ...
        List<StackTraceItemInternal> suppressed4Stacktrace = Arrays.asList(mock(StackTraceItemInternal.class));
        ...
        ThrowableModel mainModel = new ThrowableModel(
                ...
                new ThrowableModel(
                        ...
                        Arrays.asList(new ThrowableModel(suppressed3ExceptionClass, suppressed3Message, suppressed3Stacktrace, null, null))
                ),
                Arrays.asList(
                        new ThrowableModel(
                        ...
                        new ThrowableModel(
                                ...
                                null,
                                Arrays.asList(new ThrowableModel(suppressed4ExceptionClass, suppressed4Message, suppressed4Stacktrace, null, null))
                        )
                )
        );
