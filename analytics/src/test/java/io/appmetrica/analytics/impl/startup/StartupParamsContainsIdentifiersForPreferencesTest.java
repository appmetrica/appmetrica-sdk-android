...
public class StartupParamsContainsIdentifiersForPreferencesTest extends CommonTest {
    ...
    private String mInputDeviceIdHash;
    private String mInputUuid;
    private String mInputGetAdUrl;
    private String mInputReportAdUrl;
    private String mGaid;
    private String mHoaid;
    private String yandexAdvId;
    private Map<String, List<String>> customSdkHosts;
    private IdentifiersResult sslFeature;
    private String mInputResponseClids;
    private String mInputClientClids;
    private List<String> mInputCustomHosts;
