...
internal class PhoneNormalizerTest(
    ...
    companion object {
        ...
        fun data() = PhoneNormalizerTest::class.java.classLoader!!
            .getResourceAsStream("phone_normalizer_test.json")
            .readAllBytes()
            .let { bytes ->
            ...
            .mapNotNull { jsonObject ->
                ...
                return@mapNotNull arrayOf(
                    ...
                    jsonObject.getString("normalized").replace("+", "")
                )
            }
    }
