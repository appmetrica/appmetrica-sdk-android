...
public class SelfDiagnosticMainClientUnitFactoryTest extends ClientUnitFactoryBaseTest {
    ...
    public void testCreateClientUnit() {
        super.testCreateClientUnit(SelfDiagnosticClientUnit.class, MainReporterComponentId.class);
    }

    @Override
    protected ClientUnitFactory createClientUnitFactory() {
        return new SelfDiagnosticMainClientUnitFactory();
    }
