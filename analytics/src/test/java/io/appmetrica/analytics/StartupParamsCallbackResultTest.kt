...
class StartupParamsCallbackResultTest {
    ...
    fun allFieldsAreNotNullIfFilledParameters() {
        val result = StartupParamsCallback.Result(mapOf(
            StartupParamsCallback.YANDEX_MOBILE_METRICA_UUID to IdentifiersResult("some_uuid", IdentifierStatus.OK, null),
            StartupParamsCallback.YANDEX_MOBILE_METRICA_DEVICE_ID to IdentifiersResult("some_deviceId", IdentifierStatus.OK, null),
            StartupParamsCallback.APP_METRICA_DEVICE_ID_HASH to IdentifiersResult("some_deviceIdHash", IdentifierStatus.OK, null),
