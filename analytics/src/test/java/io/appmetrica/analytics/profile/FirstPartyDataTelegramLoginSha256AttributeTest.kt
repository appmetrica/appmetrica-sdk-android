...
internal class FirstPartyDataTelegramLoginSha256AttributeTest : CommonTest() {
    ...
    @Test
    fun withTelegramLoginValues() {
        val result = attribute.withTelegramLoginValues(values)
        ...
        assertThat(patcherArgs[0]).isEqualTo("appmetrica_1pd_telegram_sha256")
    ...
    fun withVarargValues() {
        val result = attribute.withTelegramLoginValues(*values.toTypedArray())
    ...
    fun withEmptyValues() {
        ...
        val result = attribute.withTelegramLoginValues(emptyValues)
    ...
    fun verifyAttributeKey() {
        attribute.withTelegramLoginValues(values)
    ...
    fun varargConvertedToIterable() {
        ...
        attribute.withTelegramLoginValues(val1, val2, val3)
