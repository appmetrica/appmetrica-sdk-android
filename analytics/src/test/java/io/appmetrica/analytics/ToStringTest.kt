...
@RunWith(ParameterizedRobolectricTestRunner::class) class ToStringTest(
    clazz: Any?,
    actualValue: Any,
    ...
    companion object {
        ...
        fun data(): List<Array<Any>> {
            mockStatic(NetworkServiceLocator::class.java).use {
                val networkServiceLocator = mock<NetworkServiceLocator>()
                val networkAppContext = mock<NetworkAppContext>()
                val sdkInfo = mock<SdkInfo>()
                val appInfo = mock<AppInfo>()
                whenever(networkAppContext.sdkInfo).thenReturn(sdkInfo)
                whenever(networkAppContext.appInfo).thenReturn(appInfo)
                whenever(networkServiceLocator.networkAppContext).thenReturn(networkAppContext)
                whenever(NetworkServiceLocator.getInstance()).thenReturn(networkServiceLocator)
                ...
                return listOf(
                        ...
                        arrayOf(
                            CoreRequestConfig::class.java, CoreRequestConfig(), Modifier.PRIVATE, ""
                        ),
                        arrayOf(
                        ...
                        arrayOf(
                            ...
                            PreloadInfoState(
                                "7657657", JSONObject(), true, true, DistributionSource.APP
                            ),
                            0, "filled"
                        ),
                        arrayOf(
                            PreloadInfoState::class.java,
                            PreloadInfoState(
                                null, JSONObject(), false, false, DistributionSource.UNDEFINED
                            ),
                            0, "nullable"
                        ),
                        arrayOf(
                            ...
                            PreloadInfoData.Candidate(
                                "7657657", JSONObject(), DistributionSource.APP
                            ),
                            0, "filled"
                        ),
                        arrayOf(
                            PreloadInfoData.Candidate::class.java,
                            PreloadInfoData.Candidate(
                                null, JSONObject(), DistributionSource.UNDEFINED
                            ),
                            0, "empty"
                        ),
                        arrayOf(
                            CacheControl::class.java, CacheControl(10L), 0, ""
                        ),
                        arrayOf(
                        ...
                        arrayOf(
                            ECommerceAmount::class.java, ECommerceAmount(BigDecimal.TEN, "unit"), 0, ""
                        ),
                        arrayOf(
                        ...
                        arrayOf(
                            ...
                            CartItemWrapper(
                                MockUtils.mockForToString(),
                                BigDecimal.TEN, MockUtils.mockForToString(),
                                MockUtils.mockForToString()
                            ),
                            0, ""
                        ),
                        ...
                        arrayOf(
                            ...
                            OrderInfoEvent(
                                OrderInfoEvent.EVENT_TYPE_BEGIN_CHECKOUT, MockUtils.mockForToString(),
                                MockUtils.mockForToString()
                            ),
                            0, "Begin checkout event"
                        ),
                        arrayOf(
                            OrderInfoEvent::class.java,
                            OrderInfoEvent(
                                OrderInfoEvent.EVENT_TYPE_PURCHASE, MockUtils.mockForToString(),
                                MockUtils.mockForToString()
                            ),
                            0, "Purchase event"
                        ),
                        ...
                        arrayOf(
                            ...
                            0, "with non-null fields"
                        ),
                        arrayOf(
                            ReferrerWrapper::class.java, ReferrerWrapper(null, null, null), 0, "with null fields"
                        ),
                        arrayOf(
                        ...
                        arrayOf(
                            ScreenWrapper::class.java, ScreenWrapper(null, null, null, null), 0, "with null fields"
                        ),
                        arrayOf(
                        ...
                        arrayOf(
                            BytesTruncatedInfo::class.java, BytesTruncatedInfo(100), 0, ""
                        ),
                        arrayOf(
                            BytesTruncatedInfo::class.java, CollectionTrimInfo(100, 200), 0, "with CollectionTrimInfo"
                        ),
                        arrayOf(
                            CollectionTrimInfo::class.java, CollectionTrimInfo(100, 200), 0, ""
                        ),
                        arrayOf(
                        ...
                        arrayOf(
                            Period::class.java, Period(1, Period.TimeUnit.MONTH), 0, "filled value"
                        ),
                        arrayOf(
                        ...
                        arrayOf(
                            AttributionConfig::class.java, AttributionConfig(ArrayList()), 0, "empty value"
                        ),
                        arrayOf(
                            AttributionConfig::class.java,
                            AttributionConfig(
                                listOf(
                                    Pair("key1", AttributionConfig.Filter("value1")), Pair("key 2", null)
                                )
                            ),
                            0, "filled value"
                        ),
                        arrayOf(
                            ...
                            ScreenInfo(0, 0, 0, 0f, DeviceTypeValues.PHONE),
                            0,
                            "empty value"
                        ),
                        arrayOf(
