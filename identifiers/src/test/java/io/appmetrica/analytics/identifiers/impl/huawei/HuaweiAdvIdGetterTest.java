...
public class HuaweiAdvIdGetterTest {
    ...
    @Mock
    private AdIdServiceConnectionController<OpenDeviceIdentifierService> connectionController;
    @Mock
    ...
    public void constructor() throws Exception {
        ...
        ObjectPropertyAssertions(mHuaweiAdvIdGetter)
                ...
                .checkFieldMatchPredicate(
                        ...
                        new Predicate<AdIdServiceConnectionController<OpenDeviceIdentifierService>>() {
                    @Override
                    public boolean test(AdIdServiceConnectionController<OpenDeviceIdentifierService> controller) {
    ...
    public void connectThrowConnectionException() throws Exception {
        ...
        AdsIdResult expected = new AdsIdResult(
    ...
    public void testHasServiceBindedButOK() throws Throwable {
        ...
        AdsIdResult expected = new AdsIdResult(
                IdentifierStatus.OK,
                new AdsIdInfo(Constants.Providers.HUAWEI, oaid, limitAdTracking),
                null
        );
